...
class Config(object):
    def __init__(self):
        self.model_name = 'DA_test_Seq2Seq_Att_randomTandD'
        ...
        self.save_model = './data/check_point/best_DA_test_Seq2Seq_Att__air_T:'+str(self.ntime_steps)+'_D:'+str(self.n_next)+'.pth'
